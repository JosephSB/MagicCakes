        ...
        <div class="main-container">
            <div class="contact-container">
                <div class="contact-container-left">
                    ...
                    <div class="left-body">
                        <p>Si necesitas comunicarte con nosotros, escríbenos un mensaje con tus datos y te devolveremos la llamada lo más pronto posible.</p>
                    </div>
                </div>
                <form class="form-contact" action="<?php echo  constant('URL'); ?>contact" method="POST">
