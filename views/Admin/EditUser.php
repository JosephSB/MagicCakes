...
<body>
    <div class="admin-container">
        ...
        <div class="admin-main">
            ...
            <form class="form-edit-product" action="<?php echo constant('URL'); ?>admin/usersAdmin/edit/<?php echo $this->idUser ?>"
                method="POST">
                <div class="title">
                ...
                <div class="input-container">
                    <input name="role" type="text" value="<?php echo $this->data['role'] ?>" placeholder="ROL DEL USUARIO">
                </div>
                <div class="input-container">
